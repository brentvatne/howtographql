...
You're going to build a simple clone of [Hacker News](https://news.ycombinator.com/). Here's a list of the features the app will have:
...
You'll create the React Native project with [`create-react-native-app`](https://github.com/react-community/create-react-native-app), a popular command-line tool that gives you a blank project with all required build configuration already setup.
